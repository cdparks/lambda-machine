...
-- |    makes it easy to highlight highlight the redex in the UI. Note that we
-- |    call the redex "thighlight he focus" since it might also be a lone global
...
formatNode
  ...
  => Address
  -> m Syntax.Expression
formatNode = hideFocus <<< formatRoot
