...
(function(exports) {
  ...
  var $less = function (__dict_Ord_17) {
      return function (a1) {
          return function (a2) {
              var _953 = compare(__dict_Ord_17)(a1)(a2);
              if (_953 instanceof LT) {
                  return true;
              };
              return false;
          };
  ...
  var $less$eq = function (__dict_Ord_18) {
      return function (a1) {
          return function (a2) {
              var _954 = compare(__dict_Ord_18)(a1)(a2);
              if (_954 instanceof GT) {
                  return false;
              };
              return true;
          };
...
(function(exports) {
  ...
  var maybe = function (b) {
      return function (f) {
          return function (_304) {
              if (_304 instanceof Nothing) {
                  return b;
              };
              if (_304 instanceof Just) {
                  return f(_304.value0);
              };
              throw new Error("Failed pattern match at Data.Maybe line 26, column 1 - line 27, column 1: " + [ b.constructor.name, f.constructor.name, _304.constructor.name ]);
          };
      };
  };                                                   
  ...
  var functorMaybe = new Prelude.Functor(function (fn) {
      return function (_306) {
          if (_306 instanceof Just) {
              return new Just(fn(_306.value0));
          };
  ...
  var applyMaybe = new Prelude.Apply(function () {
      ...
      return function (x) {
          if (_307 instanceof Just) {
              return Prelude["<$>"](functorMaybe)(_307.value0)(x);
          };
          if (_307 instanceof Nothing) {
              return Nothing.value;
          };
          throw new Error("Failed pattern match at Data.Maybe line 121, column 1 - line 145, column 1: " + [ _307.constructor.name, x.constructor.name ]);
      };
  });
...
(function(exports) {
  ...
  var semigroupFirst = new Prelude.Semigroup(function (_329) {
              ...
              return function (xs) {
                  var go = function (_366) {
                      return function (x) {
                          ...
                          return {
                              init: false, 
                              acc: Prelude["<>"](__dict_Monoid_7["__superclass_Prelude.Semigroup_0"]())(_366.acc)(Prelude["<>"](__dict_Monoid_7["__superclass_Prelude.Semigroup_0"]())(sep)(x))
                          };
                      };
                  };
...
(function(exports) {
  ...
  var functorEither = new Prelude.Functor(function (f) {
      return function (_425) {
          if (_425 instanceof Left) {
              return new Left(_425.value0);
          };
          if (_425 instanceof Right) {
              return new Right(f(_425.value0));
          };
          throw new Error("Failed pattern match at Data.Either line 52, column 1 - line 56, column 1: " + [ f.constructor.name, _425.constructor.name ]);
      };
  });
  var either = function (f) {
      return function (g) {
          return function (_424) {
              if (_424 instanceof Left) {
                  return f(_424.value0);
              };
              if (_424 instanceof Right) {
                  return g(_424.value0);
              };
              throw new Error("Failed pattern match at Data.Either line 28, column 1 - line 29, column 1: " + [ f.constructor.name, g.constructor.name, _424.constructor.name ]);
          };
      };
  }; 
  var applyEither = new Prelude.Apply(function () {
      ...
      return function (r) {
          if (_427 instanceof Left) {
              return new Left(_427.value0);
          };
          if (_427 instanceof Right) {
              return Prelude["<$>"](functorEither)(_427.value0)(r);
          };
          throw new Error("Failed pattern match at Data.Either line 92, column 1 - line 116, column 1: " + [ _427.constructor.name, r.constructor.name ]);
      };
  });
...
(function(exports) {
  ...
  var tail = $foreign["uncons'"](Prelude["const"](Data_Maybe.Nothing.value))(function (_589) {
      return function (xs) {
  ...
  var some = function (__dict_Alternative_4) {
      return function (__dict_Lazy_5) {
          return function (v) {
              return Prelude["<*>"]((__dict_Alternative_4["__superclass_Prelude.Applicative_0"]())["__superclass_Prelude.Apply_0"]())(Prelude["<$>"](((__dict_Alternative_4["__superclass_Control.Plus.Plus_1"]())["__superclass_Control.Alt.Alt_0"]())["__superclass_Prelude.Functor_0"]())($colon)(v))(Control_Lazy.defer(__dict_Lazy_5)(function (_587) {
...
(function(exports) {
  ...
  var semigroupList = new Prelude.Semigroup(function (_782) {
      return function (ys) {
          if (_782 instanceof Nil) {
              return ys;
          };
          if (_782 instanceof Cons) {
              return new Cons(_782.value0, Prelude["<>"](semigroupList)(_782.value1)(ys));
          };
          throw new Error("Failed pattern match: " + [ _782.constructor.name, ys.constructor.name ]);
      };
  });
  var reverse = (function () {
      var go = function (__copy_acc) {
          return function (__copy__760) {
              var acc = __copy_acc;
              var _760 = __copy__760;
              tco: while (true) {
                  var acc_1 = acc;
                  if (_760 instanceof Nil) {
                      return acc_1;
                  };
                  if (_760 instanceof Cons) {
                      var __tco_acc = new Cons(_760.value0, acc);
                      var __tco__760 = _760.value1;
                      acc = __tco_acc;
                      _760 = __tco__760;
                      continue tco;
                  };
                  throw new Error("Failed pattern match at Data.List line 368, column 1 - line 369, column 1: " + [ acc.constructor.name, _760.constructor.name ]);
              };
          };
      };
      return go(Nil.value);
  ...
  var functorList = new Prelude.Functor(function (f) {
      return function (lst) {
          var go = function (__copy__783) {
              return function (__copy_acc) {
                  var _783 = __copy__783;
                  var acc = __copy_acc;
                  tco: while (true) {
                      if (_783 instanceof Nil) {
                          return acc;
                      };
                      if (_783 instanceof Cons) {
                          var __tco__783 = _783.value1;
                          var __tco_acc = new Cons(f(_783.value0), acc);
                          _783 = __tco__783;
                          acc = __tco_acc;
                          continue tco;
                      };
                      throw new Error("Failed pattern match at Data.List line 731, column 1 - line 738, column 1: " + [ _783.constructor.name, acc.constructor.name ]);
                  };
              };
          };
  ...
  var foldableList = new Data_Foldable.Foldable(function (__dict_Monoid_18) {
      return function (f) {
          return Data_Foldable.foldl(foldableList)(function (acc) {
              return function (_2942) {
                  return Prelude.append(__dict_Monoid_18["__superclass_Prelude.Semigroup_0"]())(acc)(f(_2942));
              };
      ...
      var go = function (__copy_o) {
          return function (__copy_b) {
              return function (__copy__785) {
                  var o = __copy_o;
                  var b = __copy_b;
                  var _785 = __copy__785;
                  tco: while (true) {
                      var b_1 = b;
                      ...
                      if (_785 instanceof Cons) {
                          var __tco_o = o;
                          var __tco_b = o(b)(_785.value0);
                          var __tco__785 = _785.value1;
                          o = __tco_o;
                          b = __tco_b;
                          _785 = __tco__785;
                          continue tco;
                      };
                      throw new Error("Failed pattern match: " + [ o.constructor.name, b.constructor.name, _785.constructor.name ]);
                  };
              };
          };
      };
      ...
      return function (b) {
          return function (_784) {
              ...
              if (_784 instanceof Cons) {
                  return o(_784.value0)(Data_Foldable.foldr(foldableList)(o)(b)(_784.value1));
              };
              throw new Error("Failed pattern match: " + [ o.constructor.name, b.constructor.name, _784.constructor.name ]);
          };
      };
  });
  ...
  var applyList = new Prelude.Apply(function () {
      ...
      return function (xs) {
          ...
          if (_788 instanceof Cons) {
              return Prelude["<>"](semigroupList)(Prelude["<$>"](functorList)(_788.value0)(xs))(Prelude["<*>"](applyList)(_788.value1)(xs));
          };
          throw new Error("Failed pattern match: " + [ _788.constructor.name, xs.constructor.name ]);
      };
  });
...
(function(exports) {
  ...
  var values = function (_802) {
      if (_802 instanceof Leaf) {
          return Data_List.Nil.value;
      };
      if (_802 instanceof Two) {
          return Prelude["++"](Data_List.semigroupList)(values(_802.value0))(Prelude["++"](Data_List.semigroupList)(Prelude.pure(Data_List.applicativeList)(_802.value2))(values(_802.value3)));
      };
      if (_802 instanceof Three) {
          return Prelude["++"](Data_List.semigroupList)(values(_802.value0))(Prelude["++"](Data_List.semigroupList)(Prelude.pure(Data_List.applicativeList)(_802.value2))(Prelude["++"](Data_List.semigroupList)(values(_802.value3))(Prelude["++"](Data_List.semigroupList)(Prelude.pure(Data_List.applicativeList)(_802.value5))(values(_802.value6)))));
      };
      throw new Error("Failed pattern match: " + [ _802.constructor.name ]);
  };
  var toList = function (_800) {
      if (_800 instanceof Leaf) {
          return Data_List.Nil.value;
      };
      if (_800 instanceof Two) {
          return Prelude["++"](Data_List.semigroupList)(toList(_800.value0))(Prelude["++"](Data_List.semigroupList)(Prelude.pure(Data_List.applicativeList)(new Data_Tuple.Tuple(_800.value1, _800.value2)))(toList(_800.value3)));
      };
      if (_800 instanceof Three) {
          return Prelude["++"](Data_List.semigroupList)(toList(_800.value0))(Prelude["++"](Data_List.semigroupList)(Prelude.pure(Data_List.applicativeList)(new Data_Tuple.Tuple(_800.value1, _800.value2)))(Prelude["++"](Data_List.semigroupList)(toList(_800.value3))(Prelude["++"](Data_List.semigroupList)(Prelude.pure(Data_List.applicativeList)(new Data_Tuple.Tuple(_800.value4, _800.value5)))(toList(_800.value6)))));
      };
      throw new Error("Failed pattern match: " + [ _800.constructor.name ]);
  };
  var size = function (_3503) {
      return Data_List.length(values(_3503));
  };
      ...
      return function (__copy_k) {
          return function (__copy__797) {
              ...
              tco: while (true) {
                  ...
                  var k_1 = k;
                  if (_797 instanceof Two && Prelude["=="](__dict_Ord_6["__superclass_Prelude.Eq_0"]())(k_1)(_797.value1)) {
                      return new Data_Maybe.Just(_797.value2);
                  };
                  var k_1 = k;
                  if (_797 instanceof Two && Prelude["<"](__dict_Ord_6)(k_1)(_797.value1)) {
                      var __tco___dict_Ord_6 = __dict_Ord_6;
                      var __tco__797 = _797.value0;
                  ...
                  var k_1 = k;
                  if (_797 instanceof Three && Prelude["=="](__dict_Ord_6["__superclass_Prelude.Eq_0"]())(k_1)(_797.value1)) {
                      return new Data_Maybe.Just(_797.value2);
                  };
                  var k_1 = k;
                  if (_797 instanceof Three && Prelude["=="](__dict_Ord_6["__superclass_Prelude.Eq_0"]())(k_1)(_797.value4)) {
                      return new Data_Maybe.Just(_797.value5);
                  };
                  var k_1 = k;
                  if (_797 instanceof Three && Prelude["<"](__dict_Ord_6)(k_1)(_797.value1)) {
                      var __tco___dict_Ord_6 = __dict_Ord_6;
                      var __tco__797 = _797.value0;
                      __dict_Ord_6 = __tco___dict_Ord_6;
                      k = k_1;
                  ...
                  var k_1 = k;
                  if (_797 instanceof Three && (Prelude["<"](__dict_Ord_6)(_797.value1)(k_1) && Prelude["<="](__dict_Ord_6)(k_1)(_797.value4))) {
                      var __tco___dict_Ord_6 = __dict_Ord_6;
                      var __tco__797 = _797.value3;
                      __dict_Ord_6 = __tco___dict_Ord_6;
                      k = k_1;
                  ...
                  if (_797 instanceof Three) {
                      var __tco___dict_Ord_6 = __dict_Ord_6;
                      var __tco_k = k;
                      var __tco__797 = _797.value6;
                      __dict_Ord_6 = __tco___dict_Ord_6;
                      k = __tco_k;
                      _797 = __tco__797;
                      continue tco;
                  };
                  throw new Error("Failed pattern match: " + [ k.constructor.name, _797.constructor.name ]);
              };
          };
      };
  };
  ...
  var keys = function (_801) {
      if (_801 instanceof Leaf) {
          return Data_List.Nil.value;
      };
      if (_801 instanceof Two) {
          return Prelude["++"](Data_List.semigroupList)(keys(_801.value0))(Prelude["++"](Data_List.semigroupList)(Prelude.pure(Data_List.applicativeList)(_801.value1))(keys(_801.value3)));
      };
      if (_801 instanceof Three) {
          return Prelude["++"](Data_List.semigroupList)(keys(_801.value0))(Prelude["++"](Data_List.semigroupList)(Prelude.pure(Data_List.applicativeList)(_801.value1))(Prelude["++"](Data_List.semigroupList)(keys(_801.value3))(Prelude["++"](Data_List.semigroupList)(Prelude.pure(Data_List.applicativeList)(_801.value4))(keys(_801.value6)))));
      };
      throw new Error("Failed pattern match: " + [ _801.constructor.name ]);
  };
  var functorMap = new Prelude.Functor(function (f) {
      return function (_803) {
          if (_803 instanceof Leaf) {
              return Leaf.value;
          };
          if (_803 instanceof Two) {
              return new Two(Prelude.map(functorMap)(f)(_803.value0), _803.value1, f(_803.value2), Prelude.map(functorMap)(f)(_803.value3));
          };
          if (_803 instanceof Three) {
              return new Three(Prelude.map(functorMap)(f)(_803.value0), _803.value1, f(_803.value2), Prelude.map(functorMap)(f)(_803.value3), _803.value4, f(_803.value5), Prelude.map(functorMap)(f)(_803.value6));
          };
          throw new Error("Failed pattern match: " + [ f.constructor.name, _803.constructor.name ]);
      };
  });
  var fromZipper = function (__copy___dict_Ord_8) {
      return function (__copy__798) {
          return function (__copy__799) {
              ...
              tco: while (true) {
                  if (_798 instanceof Data_List.Nil) {
                      return _799;
                  };
                  if (_798 instanceof Data_List.Cons && _798.value0 instanceof TwoLeft) {
                      var __tco___dict_Ord_8 = __dict_Ord_8;
                      var __tco__798 = _798.value1;
                      var __tco__799 = new Two(_799, _798.value0.value0, _798.value0.value1, _798.value0.value2);
                      __dict_Ord_8 = __tco___dict_Ord_8;
                      _798 = __tco__798;
                      _799 = __tco__799;
                      continue tco;
                  };
                  if (_798 instanceof Data_List.Cons && _798.value0 instanceof TwoRight) {
                      var __tco___dict_Ord_8 = __dict_Ord_8;
                      var __tco__798 = _798.value1;
                      var __tco__799 = new Two(_798.value0.value0, _798.value0.value1, _798.value0.value2, _799);
                      __dict_Ord_8 = __tco___dict_Ord_8;
                      _798 = __tco__798;
                      _799 = __tco__799;
                      continue tco;
                  };
                  if (_798 instanceof Data_List.Cons && _798.value0 instanceof ThreeLeft) {
                      var __tco___dict_Ord_8 = __dict_Ord_8;
                      var __tco__798 = _798.value1;
                      var __tco__799 = new Three(_799, _798.value0.value0, _798.value0.value1, _798.value0.value2, _798.value0.value3, _798.value0.value4, _798.value0.value5);
                      __dict_Ord_8 = __tco___dict_Ord_8;
                      _798 = __tco__798;
                      _799 = __tco__799;
                      continue tco;
                  };
                  if (_798 instanceof Data_List.Cons && _798.value0 instanceof ThreeMiddle) {
                      var __tco___dict_Ord_8 = __dict_Ord_8;
                      var __tco__798 = _798.value1;
                      var __tco__799 = new Three(_798.value0.value0, _798.value0.value1, _798.value0.value2, _799, _798.value0.value3, _798.value0.value4, _798.value0.value5);
                      __dict_Ord_8 = __tco___dict_Ord_8;
                      _798 = __tco__798;
                      _799 = __tco__799;
                      continue tco;
                  };
                  if (_798 instanceof Data_List.Cons && _798.value0 instanceof ThreeRight) {
                      var __tco___dict_Ord_8 = __dict_Ord_8;
                      var __tco__798 = _798.value1;
                      var __tco__799 = new Three(_798.value0.value0, _798.value0.value1, _798.value0.value2, _798.value0.value3, _798.value0.value4, _798.value0.value5, _799);
                      __dict_Ord_8 = __tco___dict_Ord_8;
                      _798 = __tco__798;
                      _799 = __tco__799;
                      continue tco;
                  };
                  throw new Error("Failed pattern match: " + [ _798.constructor.name, _799.constructor.name ]);
              };
          };
      };
  };
  var insert = function (__dict_Ord_9) {
      var up = function (__copy__806) {
          return function (__copy__807) {
              var _806 = __copy__806;
              var _807 = __copy__807;
              tco: while (true) {
                  if (_806 instanceof Data_List.Nil) {
                      return new Two(_807.value0, _807.value1, _807.value2, _807.value3);
                  };
                  if (_806 instanceof Data_List.Cons && _806.value0 instanceof TwoLeft) {
                      return fromZipper(__dict_Ord_9)(_806.value1)(new Three(_807.value0, _807.value1, _807.value2, _807.value3, _806.value0.value0, _806.value0.value1, _806.value0.value2));
                  };
                  if (_806 instanceof Data_List.Cons && _806.value0 instanceof TwoRight) {
                      return fromZipper(__dict_Ord_9)(_806.value1)(new Three(_806.value0.value0, _806.value0.value1, _806.value0.value2, _807.value0, _807.value1, _807.value2, _807.value3));
                  };
                  if (_806 instanceof Data_List.Cons && _806.value0 instanceof ThreeLeft) {
                      var __tco__806 = _806.value1;
                      var __tco__807 = new KickUp(new Two(_807.value0, _807.value1, _807.value2, _807.value3), _806.value0.value0, _806.value0.value1, new Two(_806.value0.value2, _806.value0.value3, _806.value0.value4, _806.value0.value5));
                      _806 = __tco__806;
                      _807 = __tco__807;
                      continue tco;
                  };
                  if (_806 instanceof Data_List.Cons && _806.value0 instanceof ThreeMiddle) {
                      var __tco__806 = _806.value1;
                      var __tco__807 = new KickUp(new Two(_806.value0.value0, _806.value0.value1, _806.value0.value2, _807.value0), _807.value1, _807.value2, new Two(_807.value3, _806.value0.value3, _806.value0.value4, _806.value0.value5));
                      _806 = __tco__806;
                      _807 = __tco__807;
                      continue tco;
                  };
                  if (_806 instanceof Data_List.Cons && _806.value0 instanceof ThreeRight) {
                      var __tco__806 = _806.value1;
                      var __tco__807 = new KickUp(new Two(_806.value0.value0, _806.value0.value1, _806.value0.value2, _806.value0.value3), _806.value0.value4, _806.value0.value5, new Two(_807.value0, _807.value1, _807.value2, _807.value3));
                      _806 = __tco__806;
                      _807 = __tco__807;
                      continue tco;
                  };
                  throw new Error("Failed pattern match at Data.Map line 150, column 1 - line 151, column 1: " + [ _806.constructor.name, _807.constructor.name ]);
              };
          };
      };
              ...
              return function (__copy_v) {
                  return function (__copy__805) {
                      ...
                      tco: while (true) {
                          ...
                          var k_1 = k;
                          var v_1 = v;
                          if (_805 instanceof Two && Prelude["=="](__dict_Ord_9["__superclass_Prelude.Eq_0"]())(k_1)(_805.value1)) {
                              return fromZipper(__dict_Ord_9)(ctx_1)(new Two(_805.value0, k_1, v_1, _805.value3));
                          };
                          var ctx_1 = ctx;
                          var k_1 = k;
                          var v_1 = v;
                          if (_805 instanceof Two && Prelude["<"](__dict_Ord_9)(k_1)(_805.value1)) {
                          ...
                          var k_1 = k;
                          var v_1 = v;
                          if (_805 instanceof Three && Prelude["=="](__dict_Ord_9["__superclass_Prelude.Eq_0"]())(k_1)(_805.value1)) {
                              return fromZipper(__dict_Ord_9)(ctx_1)(new Three(_805.value0, k_1, v_1, _805.value3, _805.value4, _805.value5, _805.value6));
                          };
                          var ctx_1 = ctx;
                          var k_1 = k;
                          var v_1 = v;
                          if (_805 instanceof Three && Prelude["=="](__dict_Ord_9["__superclass_Prelude.Eq_0"]())(k_1)(_805.value4)) {
                              return fromZipper(__dict_Ord_9)(ctx_1)(new Three(_805.value0, _805.value1, _805.value2, _805.value3, k_1, v_1, _805.value6));
                          };
                          var ctx_1 = ctx;
                          var k_1 = k;
                          var v_1 = v;
                          if (_805 instanceof Three && Prelude["<"](__dict_Ord_9)(k_1)(_805.value1)) {
                              var __tco_ctx = new Data_List.Cons(new ThreeLeft(_805.value1, _805.value2, _805.value3, _805.value4, _805.value5, _805.value6), ctx_1);
                              var __tco__805 = _805.value0;
                              ctx = __tco_ctx;
                              k = k_1;
                              v = v_1;
                          ...
                          var k_1 = k;
                          var v_1 = v;
                          if (_805 instanceof Three && (Prelude["<"](__dict_Ord_9)(_805.value1)(k_1) && Prelude["<="](__dict_Ord_9)(k_1)(_805.value4))) {
                              var __tco_ctx = new Data_List.Cons(new ThreeMiddle(_805.value0, _805.value1, _805.value2, _805.value4, _805.value5, _805.value6), ctx_1);
                              var __tco__805 = _805.value3;
                              ctx = __tco_ctx;
                              k = k_1;
                              v = v_1;
                          ...
                          throw new Error("Failed pattern match at Data.Map line 150, column 1 - line 151, column 1: " + [ ctx.constructor.name, k.constructor.name, v.constructor.name, _805.constructor.name ]);
                      };
                  };
              };
          };
      ...
      return function (__dict_Foldable_14) {
          return Data_Foldable.foldl(__dict_Foldable_14)(function (m) {
              return function (_793) {
                  return insert(__dict_Ord_13)(_793.value0)(_793.value1)(m);
              };
          })(empty);
      };
  };
  ...
  var $$delete = function (__dict_Ord_17) {
      var up = function (__copy__809) {
          return function (__copy__810) {
              var _809 = __copy__809;
              var _810 = __copy__810;
              tco: while (true) {
                  if (_809 instanceof Data_List.Nil) {
                      return _810;
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof TwoLeft && (_809.value0.value2 instanceof Leaf && _810 instanceof Leaf))) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Two(Leaf.value, _809.value0.value0, _809.value0.value1, Leaf.value));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof TwoRight && (_809.value0.value0 instanceof Leaf && _810 instanceof Leaf))) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Two(Leaf.value, _809.value0.value1, _809.value0.value2, Leaf.value));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof TwoLeft && _809.value0.value2 instanceof Two)) {
                      var __tco__809 = _809.value1;
                      var __tco__810 = new Three(_810, _809.value0.value0, _809.value0.value1, _809.value0.value2.value0, _809.value0.value2.value1, _809.value0.value2.value2, _809.value0.value2.value3);
                      _809 = __tco__809;
                      _810 = __tco__810;
                      continue tco;
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof TwoRight && _809.value0.value0 instanceof Two)) {
                      var __tco__809 = _809.value1;
                      var __tco__810 = new Three(_809.value0.value0.value0, _809.value0.value0.value1, _809.value0.value0.value2, _809.value0.value0.value3, _809.value0.value1, _809.value0.value2, _810);
                      _809 = __tco__809;
                      _810 = __tco__810;
                      continue tco;
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof TwoLeft && _809.value0.value2 instanceof Three)) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Two(new Two(_810, _809.value0.value0, _809.value0.value1, _809.value0.value2.value0), _809.value0.value2.value1, _809.value0.value2.value2, new Two(_809.value0.value2.value3, _809.value0.value2.value4, _809.value0.value2.value5, _809.value0.value2.value6)));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof TwoRight && _809.value0.value0 instanceof Three)) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Two(new Two(_809.value0.value0.value0, _809.value0.value0.value1, _809.value0.value0.value2, _809.value0.value0.value3), _809.value0.value0.value4, _809.value0.value0.value5, new Two(_809.value0.value0.value6, _809.value0.value1, _809.value0.value2, _810)));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof ThreeLeft && (_809.value0.value2 instanceof Leaf && (_809.value0.value5 instanceof Leaf && _810 instanceof Leaf)))) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Three(Leaf.value, _809.value0.value0, _809.value0.value1, Leaf.value, _809.value0.value3, _809.value0.value4, Leaf.value));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof ThreeMiddle && (_809.value0.value0 instanceof Leaf && (_809.value0.value5 instanceof Leaf && _810 instanceof Leaf)))) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Three(Leaf.value, _809.value0.value1, _809.value0.value2, Leaf.value, _809.value0.value3, _809.value0.value4, Leaf.value));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof ThreeRight && (_809.value0.value0 instanceof Leaf && (_809.value0.value3 instanceof Leaf && _810 instanceof Leaf)))) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Three(Leaf.value, _809.value0.value1, _809.value0.value2, Leaf.value, _809.value0.value4, _809.value0.value5, Leaf.value));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof ThreeLeft && _809.value0.value2 instanceof Two)) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Two(new Three(_810, _809.value0.value0, _809.value0.value1, _809.value0.value2.value0, _809.value0.value2.value1, _809.value0.value2.value2, _809.value0.value2.value3), _809.value0.value3, _809.value0.value4, _809.value0.value5));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof ThreeMiddle && _809.value0.value0 instanceof Two)) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Two(new Three(_809.value0.value0.value0, _809.value0.value0.value1, _809.value0.value0.value2, _809.value0.value0.value3, _809.value0.value1, _809.value0.value2, _810), _809.value0.value3, _809.value0.value4, _809.value0.value5));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof ThreeMiddle && _809.value0.value5 instanceof Two)) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Two(_809.value0.value0, _809.value0.value1, _809.value0.value2, new Three(_810, _809.value0.value3, _809.value0.value4, _809.value0.value5.value0, _809.value0.value5.value1, _809.value0.value5.value2, _809.value0.value5.value3)));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof ThreeRight && _809.value0.value3 instanceof Two)) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Two(_809.value0.value0, _809.value0.value1, _809.value0.value2, new Three(_809.value0.value3.value0, _809.value0.value3.value1, _809.value0.value3.value2, _809.value0.value3.value3, _809.value0.value4, _809.value0.value5, _810)));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof ThreeLeft && _809.value0.value2 instanceof Three)) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Three(new Two(_810, _809.value0.value0, _809.value0.value1, _809.value0.value2.value0), _809.value0.value2.value1, _809.value0.value2.value2, new Two(_809.value0.value2.value3, _809.value0.value2.value4, _809.value0.value2.value5, _809.value0.value2.value6), _809.value0.value3, _809.value0.value4, _809.value0.value5));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof ThreeMiddle && _809.value0.value0 instanceof Three)) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Three(new Two(_809.value0.value0.value0, _809.value0.value0.value1, _809.value0.value0.value2, _809.value0.value0.value3), _809.value0.value0.value4, _809.value0.value0.value5, new Two(_809.value0.value0.value6, _809.value0.value1, _809.value0.value2, _810), _809.value0.value3, _809.value0.value4, _809.value0.value5));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof ThreeMiddle && _809.value0.value5 instanceof Three)) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Three(_809.value0.value0, _809.value0.value1, _809.value0.value2, new Two(_810, _809.value0.value3, _809.value0.value4, _809.value0.value5.value0), _809.value0.value5.value1, _809.value0.value5.value2, new Two(_809.value0.value5.value3, _809.value0.value5.value4, _809.value0.value5.value5, _809.value0.value5.value6)));
                  };
                  if (_809 instanceof Data_List.Cons && (_809.value0 instanceof ThreeRight && _809.value0.value3 instanceof Three)) {
                      return fromZipper(__dict_Ord_17)(_809.value1)(new Three(_809.value0.value0, _809.value0.value1, _809.value0.value2, new Two(_809.value0.value3.value0, _809.value0.value3.value1, _809.value0.value3.value2, _809.value0.value3.value3), _809.value0.value3.value4, _809.value0.value3.value5, new Two(_809.value0.value3.value6, _809.value0.value4, _809.value0.value5, _810)));
                  };
      ...
      var removeMaxNode = function (__copy_ctx) {
          return function (__copy__812) {
              ...
              tco: while (true) {
                  var ctx_1 = ctx;
                  if (_812 instanceof Two && (_812.value0 instanceof Leaf && _812.value3 instanceof Leaf)) {
                      return up(ctx_1)(Leaf.value);
                  };
                  var ctx_1 = ctx;
                  if (_812 instanceof Two) {
                      var __tco_ctx = new Data_List.Cons(new TwoRight(_812.value0, _812.value1, _812.value2), ctx_1);
                      var __tco__812 = _812.value3;
                      ctx = __tco_ctx;
                      _812 = __tco__812;
                      continue tco;
                  };
                  var ctx_1 = ctx;
                  if (_812 instanceof Three && (_812.value0 instanceof Leaf && (_812.value3 instanceof Leaf && _812.value6 instanceof Leaf))) {
                      return up(new Data_List.Cons(new TwoRight(Leaf.value, _812.value1, _812.value2), ctx_1))(Leaf.value);
                  };
                  if (_812 instanceof Three) {
                      var __tco_ctx = new Data_List.Cons(new ThreeRight(_812.value0, _812.value1, _812.value2, _812.value3, _812.value4, _812.value5), ctx);
                      var __tco__812 = _812.value6;
                      ctx = __tco_ctx;
                      _812 = __tco__812;
                      continue tco;
                  };
                  if (_812 instanceof Leaf) {
                      return Data_Maybe_Unsafe.unsafeThrow("Impossible case in 'removeMaxNode'");
                  };
                  throw new Error("Failed pattern match at Data.Map line 173, column 1 - line 174, column 1: " + [ ctx.constructor.name, _812.constructor.name ]);
              };
          };
      };
      var maxNode = function (__copy__811) {
          var _811 = __copy__811;
          tco: while (true) {
              if (_811 instanceof Two && _811.value3 instanceof Leaf) {
                  return {
                      key: _811.value1, 
                      value: _811.value2
                  };
              };
              if (_811 instanceof Two) {
                  var __tco__811 = _811.value3;
                  _811 = __tco__811;
                  continue tco;
              };
              if (_811 instanceof Three && _811.value6 instanceof Leaf) {
                  return {
                      key: _811.value4, 
                      value: _811.value5
                  };
              };
              if (_811 instanceof Three) {
                  var __tco__811 = _811.value6;
                  _811 = __tco__811;
                  continue tco;
              };
              if (_811 instanceof Leaf) {
                  return Data_Maybe_Unsafe.unsafeThrow("Impossible case in 'maxNode'");
              };
              throw new Error("Failed pattern match at Data.Map line 173, column 1 - line 174, column 1: " + [ _811.constructor.name ]);
          };
      };
      var down = function (__copy_ctx) {
          return function (__copy_k) {
              return function (__copy__808) {
                  ...
                  tco: while (true) {
                      var ctx_1 = ctx;
                      if (_808 instanceof Leaf) {
                          return fromZipper(__dict_Ord_17)(ctx_1)(Leaf.value);
                      };
                      var ctx_1 = ctx;
                      var k_1 = k;
                      if (_808 instanceof Two && (_808.value0 instanceof Leaf && (_808.value3 instanceof Leaf && Prelude["=="](__dict_Ord_17["__superclass_Prelude.Eq_0"]())(k_1)(_808.value1)))) {
                          return up(ctx_1)(Leaf.value);
                      };
                      var ctx_1 = ctx;
                      var k_1 = k;
                      if (_808 instanceof Two) {
                          if (Prelude["=="](__dict_Ord_17["__superclass_Prelude.Eq_0"]())(k_1)(_808.value1)) {
                              var max = maxNode(_808.value0);
                              return removeMaxNode(new Data_List.Cons(new TwoLeft(max.key, max.value, _808.value3), ctx_1))(_808.value0);
                          };
                          if (Prelude["<"](__dict_Ord_17)(k_1)(_808.value1)) {
                              var __tco_ctx = new Data_List.Cons(new TwoLeft(_808.value1, _808.value2, _808.value3), ctx_1);
                              var __tco__808 = _808.value0;
                              ctx = __tco_ctx;
                              k = k_1;
                              _808 = __tco__808;
                              continue tco;
                          ...
                          if (Prelude.otherwise) {
                              var __tco_ctx = new Data_List.Cons(new TwoRight(_808.value0, _808.value1, _808.value2), ctx_1);
                      ...
                      var ctx_1 = ctx;
                      var k_1 = k;
                      if (_808 instanceof Three && (_808.value0 instanceof Leaf && (_808.value3 instanceof Leaf && _808.value6 instanceof Leaf))) {
                          if (Prelude["=="](__dict_Ord_17["__superclass_Prelude.Eq_0"]())(k_1)(_808.value1)) {
                              return fromZipper(__dict_Ord_17)(ctx_1)(new Two(Leaf.value, _808.value4, _808.value5, Leaf.value));
                          };
                          if (Prelude["=="](__dict_Ord_17["__superclass_Prelude.Eq_0"]())(k_1)(_808.value4)) {
                              return fromZipper(__dict_Ord_17)(ctx_1)(new Two(Leaf.value, _808.value1, _808.value2, Leaf.value));
                          };
                      };
                      if (_808 instanceof Three) {
                          if (Prelude["=="](__dict_Ord_17["__superclass_Prelude.Eq_0"]())(k)(_808.value1)) {
                              var max = maxNode(_808.value0);
                              return removeMaxNode(new Data_List.Cons(new ThreeLeft(max.key, max.value, _808.value3, _808.value4, _808.value5, _808.value6), ctx))(_808.value0);
                          };
                          if (Prelude["=="](__dict_Ord_17["__superclass_Prelude.Eq_0"]())(k)(_808.value4)) {
                              var max = maxNode(_808.value3);
                              return removeMaxNode(new Data_List.Cons(new ThreeMiddle(_808.value0, _808.value1, _808.value2, max.key, max.value, _808.value6), ctx))(_808.value3);
                          };
                          if (Prelude["<"](__dict_Ord_17)(k)(_808.value1)) {
                              var __tco_ctx = new Data_List.Cons(new ThreeLeft(_808.value1, _808.value2, _808.value3, _808.value4, _808.value5, _808.value6), ctx);
                              var __tco_k = k;
                              var __tco__808 = _808.value0;
                              ctx = __tco_ctx;
                              k = __tco_k;
                          ...
                          if (Prelude["<"](__dict_Ord_17)(_808.value1)(k) && Prelude["<"](__dict_Ord_17)(k)(_808.value4)) {
                              var __tco_ctx = new Data_List.Cons(new ThreeMiddle(_808.value0, _808.value1, _808.value2, _808.value4, _808.value5, _808.value6), ctx);
                              var __tco_k = k;
                              var __tco__808 = _808.value3;
                              ctx = __tco_ctx;
                              k = __tco_k;
                          ...
                          if (Prelude.otherwise) {
                              var __tco_ctx = new Data_List.Cons(new ThreeRight(_808.value0, _808.value1, _808.value2, _808.value3, _808.value4, _808.value5), ctx);
                              var __tco_k = k;
                      ...
                      throw new Error("Failed pattern match at Data.Map line 173, column 1 - line 174, column 1: " + [ ctx.constructor.name, k.constructor.name, _808.constructor.name ]);
                  };
              };
          };
      };
...
(function(exports) {
  ...
  var toList = function (_820) {
      return Data_Map.keys(_820.value0);
  };
  var size = function (_821) {
      return Data_Map.size(_821.value0);
  };
  var member = function (__dict_Ord_5) {
      return function (a) {
          return function (_817) {
              return Data_Map.member(__dict_Ord_5)(a)(_817.value0);
          };
      };
  };
  var insert = function (__dict_Ord_6) {
      return function (a) {
          return function (_818) {
              return new Set(Data_Map.insert(__dict_Ord_6)(a)(Prelude.unit)(_818.value0));
          };
      };
  };
  var foldableSet = new Data_Foldable.Foldable(function (__dict_Monoid_7) {
      return function (f) {
          return function (_3533) {
              return Data_Foldable.foldMap(Data_List.foldableList)(__dict_Monoid_7)(f)(toList(_3533));
          };
      };
  }, function (f) {
      return function (x) {
          return function (_3534) {
              return Data_Foldable.foldl(Data_List.foldableList)(f)(x)(toList(_3534));
          };
      };
  }, function (f) {
      return function (x) {
          return function (_3535) {
              return Data_Foldable.foldr(Data_List.foldableList)(f)(x)(toList(_3535));
          };
      };
  });
  ...
  var $$delete = function (__dict_Ord_15) {
      return function (a) {
          return function (_819) {
              return new Set(Data_Map["delete"](__dict_Ord_15)(a)(_819.value0));
          };
      };
  };
...
(function(exports) {
  ...
  var isLambda = function (_671) {
      if (_671 instanceof Lambda) {
          return true;
      };
      return false;
  };
  var isComposite = function (_670) {
      if (_670 instanceof Var) {
          return false;
      };
      return true;
  };
  ...
  var namesReferencing = function (name) {
      var step_1 = function (keys) {
          return function (_826) {
              if (Data_Set.member(Prelude.ordString)(name)(freeVars(_826.value1))) {
                  return Data_Set.insert(Prelude.ordString)(_826.value0)(keys);
              };
              if (Prelude.otherwise) {
                  return keys;
              };
              throw new Error("Failed pattern match at Data.Expr line 91, column 3 - line 95, column 1: " + [ keys.constructor.name, _826.constructor.name ]);
          };
      };
...
(function(exports) {
  ...
  var updatePosString = function (pos) {
      return function (str) {
          var updatePosChar = function (_376) {
              return function (c) {
                  if (c === "\n") {
                      return new Position({
                          line: _376.value0.line + 1 | 0, 
                          column: 1
                      });
                  };
                  if (c === "\r") {
                  ...
                  if (c === "\t") {
                      return new Position({
                          line: _376.value0.line, 
                          column: (_376.value0.column + 8 | 0) - (_376.value0.column - 1) % 8
                      });
                  };
                  return new Position({
                      line: _376.value0.line, 
                      column: _376.value0.column + 1 | 0
                  });
              };
          };
...
(function(exports) {
  ...
  var fail = function (__dict_Monad_6) {
      return function (message) {
          return ParserT(function (_896) {
              return Prelude["return"](__dict_Monad_6["__superclass_Prelude.Applicative_0"]())(parseFailed(_896.value0.input)(_896.value0.position)(message));
          });
      };
  };
  ...
  var $$try = function (__dict_Functor_1) {
      return function (p) {
          var try$prime = function (s) {
              return function (pos) {
                  return function (_902) {
                      if (_902.result instanceof Data_Either.Left) {
                          return {
                              input: s, 
                              result: _902.result, 
                              consumed: false, 
          ...
          return Text_Parsing_Parser.ParserT(function (_899) {
              return Prelude["<$>"](__dict_Functor_1)(try$prime(_899.value0.input)(_899.value0.position))(Text_Parsing_Parser.unParserT(p)(new Text_Parsing_Parser.PState({
                  input: _899.value0.input, 
                  position: _899.value0.position
              })));
          });
      };
  };
...
(function(exports) {
  ...
  var string = function (__dict_Monad_0) {
      return function (str) {
          return Text_Parsing_Parser.ParserT(function (_905) {
              return Prelude["return"](__dict_Monad_0["__superclass_Prelude.Applicative_0"]())((function () {
                  var _3924 = Data_String.indexOf(str)(_905.value0.input);
                  if (_3924 instanceof Data_Maybe.Just && _3924.value0 === 0) {
                      return {
                          consumed: true, 
                          input: Data_String.drop(Data_String.length(str))(_905.value0.input), 
                          result: new Data_Either.Right(str), 
                          position: Text_Parsing_Parser_Pos.updatePosString(_905.value0.position)(str)
                      };
                  };
                  return Text_Parsing_Parser.parseFailed(_905.value0.input)(_905.value0.position)("Expected " + str);
              })());
          });
      };
  };
  var eof = function (__dict_Monad_1) {
      return Text_Parsing_Parser.ParserT(function (_904) {
          return Prelude["return"](__dict_Monad_1["__superclass_Prelude.Applicative_0"]())((function () {
              if (_904.value0.input === "") {
                  return {
                      consumed: false, 
                      input: _904.value0.input, 
                      result: new Data_Either.Right(Prelude.unit), 
                      position: _904.value0.position
                  };
              };
              return Text_Parsing_Parser.parseFailed(_904.value0.input)(_904.value0.position)("Expected EOF");
          })());
      });
  };
  var anyChar = function (__dict_Monad_2) {
      return Text_Parsing_Parser.ParserT(function (_906) {
          return Prelude["return"](__dict_Monad_2["__superclass_Prelude.Applicative_0"]())((function () {
              var _3935 = Data_String.charAt(0)(_906.value0.input);
              if (_3935 instanceof Data_Maybe.Nothing) {
                  return Text_Parsing_Parser.parseFailed(_906.value0.input)(_906.value0.position)("Unexpected EOF");
              };
              if (_3935 instanceof Data_Maybe.Just) {
                  return {
                      consumed: true, 
                      input: Data_String.drop(1)(_906.value0.input), 
                      result: new Data_Either.Right(_3935.value0), 
                      position: Text_Parsing_Parser_Pos.updatePosString(_906.value0.position)(Data_Char.toString(_3935.value0))
                  };
              };
              throw new Error("Failed pattern match at Text.Parsing.Parser.String line 40, column 1 - line 41, column 1: " + [ _3935.constructor.name ]);
          })());
      });
  };
  var satisfy = function (__dict_Monad_3) {
      return function (f) {
          return Text_Parsing_Parser_Combinators["try"](((__dict_Monad_3["__superclass_Prelude.Bind_1"]())["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Prelude.bind(Text_Parsing_Parser.bindParserT(__dict_Monad_3))(anyChar(__dict_Monad_3))(function (_110) {
              ...
              if (!_3941) {
                  return Text_Parsing_Parser.fail(__dict_Monad_3)("Character '" + (Data_String.fromChar(_110) + "' did not satisfy predicate"));
              };
              throw new Error("Failed pattern match at Text.Parsing.Parser.String line 47, column 1 - line 48, column 1: " + [ _3941.constructor.name ]);
          }));
      };
  };
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Data_Either = PS["Data.Either"];     
  var fromRight = function (_448) {
      if (_448 instanceof Data_Either.Right) {
          return _448.value0;
      };
...
(function(exports) {
  ...
  var formatParseError = function (text) {
      return function (_907) {
          var caretLine = Data_String.fromCharArray(Data_Array.replicate(_907.value0.position.value0.column - 1)(" ")) + "^";
          return "Parse error: " + (_907.value0.message + (" at column " + (Prelude.show(Prelude.showInt)(_907.value0.position.value0.column) + ("\n" + (text + ("\n" + caretLine))))));
      };
  };
...
(function(exports) {
  ...
  var spec$prime = function (getInitialState) {
      return function (renderFn) {
          return {
              ...
              componentWillMount: function (_600) {
                  return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit);
              }, 
              componentDidMount: function (_601) {
                  return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit);
              }, 
              componentWillReceiveProps: function (_603) {
                  return function (_602) {
                      return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit);
                  };
              }, 
              shouldComponentUpdate: function (_606) {
              ...
              componentWillUpdate: function (_609) {
              ...
              componentDidUpdate: function (_612) {
              ...
              componentWillUnmount: function (_613) {
                  return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit);
              }
          };
      };
  ...
  var spec = function (state) {
      return spec$prime(function (_599) {
...
(function(exports) {
  ...
  var runAction = function ($$this) {
      var go = function (_615) {
          if (_615 instanceof Pure) {
              return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit);
          };
          if (_615 instanceof Impure && _615.value0 instanceof GetState) {
              return Prelude["void"](Control_Monad_Eff.functorEff)(function __do() {
                  var _61 = React.readState($$this)();
                  return go(_615.value0.value0(_61))();
              });
          };
          if (_615 instanceof Impure && _615.value0 instanceof SetState) {
              return Prelude["void"](Control_Monad_Eff.functorEff)(function __do() {
                  React.writeState($$this)(_615.value0.value0)();
                  return go(_615.value0.value1)();
              });
          };
          if (_615 instanceof Impure && _615.value0 instanceof Wait) {
              return _615.value0.value0(go);
          };
          throw new Error("Failed pattern match at Thermite.Action line 37, column 1 - line 41, column 1: " + [ _615.constructor.name ]);
      };
      return go;
  };
  ...
  var functorActionF = new Prelude.Functor(function (f) {
      return function (_614) {
          if (_614 instanceof GetState) {
              return new GetState(function (_2195) {
                  return f(_614.value0(_2195));
              });
          };
          if (_614 instanceof SetState) {
              return new SetState(_614.value0, f(_614.value1));
          };
          if (_614 instanceof Wait) {
              return new Wait(function (k) {
                  return _614.value0(function (_2196) {
                      return k(f(_2196));
                  });
              });
          };
          throw new Error("Failed pattern match at Thermite.Action line 24, column 1 - line 34, column 1: " + [ f.constructor.name, _614.constructor.name ]);
      };
  });
  var functorAction = new Prelude.Functor(function (f) {
      return function (_616) {
          if (_616 instanceof Pure) {
              return new Pure(f(_616.value0));
          };
          if (_616 instanceof Impure) {
              return new Impure(Prelude["<$>"](functorActionF)(Prelude["<$>"](functorAction)(f))(_616.value0));
          };
          throw new Error("Failed pattern match: " + [ f.constructor.name, _616.constructor.name ]);
      };
  });
  var async = function (c) {
      return Impure.create(new Wait(function (k) {
          return c(function (_2197) {
              return k(Pure.create(_2197));
          });
      }));
  };
  ...
  var bindAction = new Prelude.Bind(function () {
      ...
      return function (f) {
          if (_617 instanceof Pure) {
              return f(_617.value0);
          };
          if (_617 instanceof Impure) {
              return Impure.create(Prelude["<#>"](functorActionF)(_617.value0)(function (a) {
                  return Prelude[">>="](bindAction)(a)(f);
              }));
          };
          throw new Error("Failed pattern match: " + [ _617.constructor.name, f.constructor.name ]);
      };
  });
  ...
  var modifyState = function (f) {
      return Prelude.bind(bindAction)(getState)(function (_62) {
          return setState(f(_62));
      });
  };
  exports["async"] = async;
...
(function(exports) {
  ...
  var displayName = function (name) {
      return function (_890) {
          var _3812 = {};
          for (var _3813 in _890) {
              if (_890.hasOwnProperty(_3813)) {
                  _3812[_3813] = _890[_3813];
              };
          };
          _3812.displayName = new Data_Maybe.Just(name);
          return _3812;
      };
  };
  var createClass = function (_891) {
      var displayName_ = Data_Maybe.fromMaybe("")(_891.displayName);
      var dispatch = function ($$this) {
          return function (action) {
              return function __do() {
                  var _77 = React.getProps($$this)();
                  return Thermite_Action.runAction($$this)(Unsafe_Coerce.unsafeCoerce(_891.performAction(_77)(action)))();
              };
          };
      };
      var render = function ($$this) {
          return Prelude["<*>"](Control_Monad_Eff.applyEff)(Prelude["<*>"](Control_Monad_Eff.applyEff)(Prelude["<$>"](Control_Monad_Eff.functorEff)(_891.render(dispatch($$this)))(React.readState($$this)))(React.getProps($$this)))(React.getChildren($$this));
      };
      var componentWillMount_ = function (ctx) {
          return Data_Maybe.maybe(Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit))(function (_3822) {
              return Control_Monad_Eff_Unsafe.unsafeInterleaveEff(dispatch(ctx)(_3822));
          })(_891.componentWillMount);
      };
      return React.createClass((function () {
          var _3816 = {};
          for (var _3817 in React.spec(_891.initialState)(render)) {
              if ((React.spec(_891.initialState)(render)).hasOwnProperty(_3817)) {
                  _3816[_3817] = (React.spec(_891.initialState)(render))[_3817];
              };
          };
          _3816.displayName = displayName_;
          _3816.componentWillMount = componentWillMount_;
          return _3816;
      })());
  };
  var componentWillMount = function (action) {
      return function (_889) {
          var _3820 = {};
          for (var _3821 in _889) {
              if (_889.hasOwnProperty(_3821)) {
                  _3820[_3821] = _889[_3821];
              };
          };
          _3820.componentWillMount = new Data_Maybe.Just(action);
          return _3820;
      };
  };
...
(function(exports) {
  ...
  var readInt = function (value) {
      ...
      var fromNumber = function (_1577) {
          return Data_Maybe.maybe(error)(Prelude.pure(Data_Either.applicativeEither))(Data_Int.fromNumber(_1577));
      };
...
(function(exports) {
  ...
  var getConst = function (_395) {
      return _395;
  };
  var functorConst = new Prelude.Functor(function (_405) {
      return function (_406) {
          return _406;
      };
  });
  var contravariantConst = new Data_Functor_Contravariant.Contravariant(function (_412) {
  ...
  var applyConst = function (__dict_Semigroup_10) {
      return new Prelude.Apply(function () {
          ...
          return function (_408) {
              return Prelude["<>"](__dict_Semigroup_10)(_407)(_408);
          };
      });
  };
...
(function(exports) {
  ...
  var getMap = function (__dict_Monoid_0) {
      return function (f) {
          return function (g) {
              return function (_1600) {
                  return Data_Const.getConst(g(Data_Const.contravariantConst)(Data_Const.applicativeConst(__dict_Monoid_0))(function (_1601) {
                      return Data_Const.Const(f(_1601));
                  })(_1600));
              };
          };
      };
  ...
  var get = function (g) {
      return function (_1602) {
          return Data_Maybe_First.runFirst(getMap(Data_Maybe_First.monoidFirst)(function (_1603) {
              return Data_Maybe_First.First(Data_Maybe.Just.create(_1603));
  ...
  var coerce = function (__dict_Contravariant_3) {
      return function (__dict_Functor_4) {
          ...
          return function (_1604) {
              return Prelude.map(__dict_Functor_4)(absurd)(Data_Functor_Contravariant.cmap(__dict_Contravariant_3)(absurd)(_1604));
          };
      };
  };
      ...
      return function (__dict_Contravariant_5) {
          return function (__dict_Applicative_6) {
              return function (g) {
                  return function (s) {
                      var _1597 = f(s);
                      if (_1597 instanceof Data_Either.Left) {
                      ...
                      if (_1597 instanceof Data_Either.Right) {
                          return coerce(__dict_Contravariant_5)((__dict_Applicative_6["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(g(_1597.value0));
                      };
                      throw new Error("Failed pattern match at Data.Foreign.Lens line 54, column 1 - line 55, column 1: " + [ _1597.constructor.name ]);
                  };
              };
          };
      };
...
(function(exports) {
  ...
  var showLevel = new Prelude.Show(function (_919) {
      if (_919 instanceof Warning) {
          return "warning";
      };
      if (_919 instanceof Danger) {
          return "danger";
      };
      throw new Error("Failed pattern match at Component.App line 38, column 1 - line 42, column 1: " + [ _919.constructor.name ]);
  });
  ...
  var renderHistory = function (hs) {
      var _3969 = Data_Array.uncons(hs);
      if (_3969 instanceof Data_Maybe.Nothing) {
          return [  ];
      };
      if (_3969 instanceof Data_Maybe.Just) {
          return Data_Array.cons(React_DOM["h4'"]([ React_DOM.text(_3969.value0.head) ]))(Prelude.map(Prelude.functorArray)(renderSyntax)(_3969.value0.tail));
      };
      throw new Error("Failed pattern match at Component.App line 312, column 1 - line 313, column 1: " + [ _3969.constructor.name ]);
  };
      ...
      return function (history) {
          return function (_918) {
              ...
              if (_918 instanceof Data_Maybe.Just) {
                  return [ React_DOM["h3'"]([ React_DOM.text("Evaluation") ]), React_DOM.div([ React_DOM_Props.className("col-sm-12") ])([ React_DOM.div([ React_DOM_Props.className("btn-group pull-right") ])([ React_DOM.button([ React_DOM_Props.className("btn btn-default"), React_DOM_Props.onClick(function (_913) {
                      return send(new Reduce(_918.value0));
                  }) ])([ React_DOM.text("Step") ]), React_DOM.button([ React_DOM_Props.className("btn btn-default"), React_DOM_Props.onClick(function (_914) {
                      return send(Clear.value);
                  }) ])([ React_DOM.text("Clear") ]), React_DOM.button([ React_DOM_Props.className("btn btn-default"), React_DOM_Props.onClick(function (_915) {
              ...
              throw new Error("Failed pattern match at Component.App line 279, column 1 - line 280, column 1: " + [ send.constructor.name, history.constructor.name, _918.constructor.name ]);
          };
      };
  };
  var renderDef = function (send) {
      return function (def) {
          return React_DOM["h4'"]([ React_DOM.div([ React_DOM_Props.className("glyphicon glyphicon-remove"), React_DOM_Props.onClick(function (_912) {
  ...
  var reduce = function (expr) {
      return function (s) {
          var _3981 = Data_Expr.step(s.env)(expr);
          if (_3981 instanceof Data_Maybe.Nothing) {
              return s;
          };
          if (_3981 instanceof Data_Maybe.Just) {
              var _3982 = {};
              for (var _3983 in s) {
                  if (s.hasOwnProperty(_3983)) {
                      _3982[_3983] = s[_3983];
                  };
              };
              _3982.history = Data_Array.cons(Data_PrettyPrint.prettyPrint(Data_Syntax.prettyPrintSyntax)(Data_Expr.exprToSyntax(_3981.value0)))(s.history);
              _3982.expr = new Data_Maybe.Just(_3981.value0);
              return _3982;
          };
          throw new Error("Failed pattern match at Component.App line 169, column 1 - line 170, column 1: " + [ _3981.constructor.name ]);
      };
  };
  var initialDefs = [ {
      name: "i", 
  ...
  var handleKeyPress = function (e) {
      var _3985 = Component_Event.getKeyCode(e);
      if (_3985 === 13) {
  ...
  var fail = function (message) {
      return function (s) {
          var _3987 = {};
          for (var _3988 in s) {
              if (s.hasOwnProperty(_3988)) {
                  _3987[_3988] = s[_3988];
              };
          };
          _3987.text = "";
          _3987.error = new Data_Maybe.Just(new Data_Tuple.Tuple(Danger.value, message));
          return _3987;
      };
  };
  var deleteByName = function (name) {
      return Data_Array.filter(Prelude[">>>"](Prelude.semigroupoidFn)(function (_5) {
          return _5.name;
      })(function (_22) {
          return Prelude["/="](Prelude.eqString)(_22)(name);
      }));
  };
  var remove = function (name) {
      return function (s) {
          ...
          var error = (function () {
              var _3989 = Data_Set.size(names) === 0;
              if (_3989) {
                  return Data_Maybe.Nothing.value;
              };
              if (!_3989) {
              ...
              throw new Error("Failed pattern match at Component.App line 136, column 1 - line 137, column 1: " + [ _3989.constructor.name ]);
          })();
          var _3990 = {};
          for (var _3991 in s) {
              if (s.hasOwnProperty(_3991)) {
                  _3990[_3991] = s[_3991];
              };
          };
          _3990.defs = deleteByName(name)(s.defs);
          _3990.env = env$prime;
          _3990.error = error;
          return _3990;
      };
  ...
  var clear = function (s) {
      var _3992 = {};
      for (var _3993 in s) {
          if (s.hasOwnProperty(_3993)) {
              _3992[_3993] = s[_3993];
          };
      };
      _3992.history = Data_Maybe.maybe([  ])(Prelude[">>>"](Prelude.semigroupoidFn)(Data_Expr.exprToSyntax)(Prelude[">>>"](Prelude.semigroupoidFn)(Data_PrettyPrint.prettyPrint(Data_Syntax.prettyPrintSyntax))(Data_Array.singleton)))(s.expr);
      return _3992;
  };
  var alert = function (send) {
      return function (_917) {
          ...
          if (_917 instanceof Data_Maybe.Just) {
              return [ React_DOM.div([ React_DOM_Props.className("col-sm-12") ])([ React_DOM.pre([ React_DOM_Props.className("alert alert-" + Prelude.show(showLevel)(_917.value0.value0)) ])([ React_DOM.span([ React_DOM_Props.className("glyphicon glyphicon-remove pull-right"), React_DOM_Props.onClick(function (_910) {
                  return send(DismissAlert.value);
              }) ])([  ]), React_DOM.text(_917.value0.value1) ]) ]) ];
          };
          throw new Error("Failed pattern match at Component.App line 220, column 1 - line 221, column 1: " + [ send.constructor.name, _917.constructor.name ]);
      };
  };
  ...
  var addExpr = function (syntax) {
      return function (s) {
          ...
          var _4000 = {};
          for (var _4001 in s) {
              if (s.hasOwnProperty(_4001)) {
                  _4000[_4001] = s[_4001];
              };
          };
          _4000.text = "";
          _4000.history = history;
          _4000.expr = expr;
          return _4000;
      };
  };
  var addDef = function (def) {
      return function (s) {
          ...
          var _4002 = Data_Set.size(missing) === 0;
          if (_4002) {
              var _4003 = {};
              for (var _4004 in s) {
                  if (s.hasOwnProperty(_4004)) {
                      _4003[_4004] = s[_4004];
                  };
              };
              _4003.text = "";
          ...
          throw new Error("Failed pattern match at Component.App line 149, column 1 - line 150, column 1: " + [ _4002.constructor.name ]);
      };
  };
  var parse = function (s) {
      ...
      var _4006 = Data_Parse.parseAll(Data_Parse.parseEither)(s.text);
      if (_4006 instanceof Data_Either.Left) {
          return fail(Data_Parse.formatParseError(s.text)(_4006.value0))(s);
      };
      if (_4006 instanceof Data_Either.Right && _4006.value0 instanceof Data_Either.Left) {
          return addDef(_4006.value0.value0)(s);
      };
      if (_4006 instanceof Data_Either.Right && _4006.value0 instanceof Data_Either.Right) {
          return addExpr(_4006.value0.value0)(s);
      };
      throw new Error("Failed pattern match at Component.App line 124, column 1 - line 125, column 1: " + [ _4006.constructor.name ]);
  };
      ...
      return function (action) {
          ...
          if (action instanceof NewText) {
              return Thermite_Action.modifyState(function (s) {
                  var _4013 = {};
                  for (var _4014 in s) {
                      if (s.hasOwnProperty(_4014)) {
                          _4013[_4014] = s[_4014];
                      };
                  };
                  _4013.text = action.value0;
                  _4013.error = Data_Maybe.Nothing.value;
                  return _4013;
              });
          };
          if (action instanceof DismissAlert) {
              return Thermite_Action.modifyState(function (s) {
                  var _4016 = {};
                  for (var _4017 in s) {
                      if (s.hasOwnProperty(_4017)) {
                          _4016[_4017] = s[_4017];
                      };
                  };
                  _4016.error = Data_Maybe.Nothing.value;
                  return _4016;
              });
          };
          ...
          if (action instanceof Save) {
              return Prelude.bind(Thermite_Action.bindAction)(Thermite_Action.getState)(function (_117) {
                  return Thermite_Action.async(function (k) {
                      var text = Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("\n")(Prelude["<>"](Prelude.semigroupArray)(Prelude.map(Prelude.functorArray)(defToString)(_117.defs))(Data_Array.reverse(_117.history)));
                      return function __do() {
...
(function(exports) {
  ...
  var body = function __do() {
      var _120 = DOM_HTML.window();
      var _119 = DOM_HTML_Window.document(_120)();
      var _118 = Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)(DOM_HTML_Document.body(_119))();
      return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude["<$>"](Data_Maybe.functorMaybe)(DOM_HTML_Types.htmlElementToElement)(_118))();
  };
  var main = function __do() {
      ...
      return (function () {
          ...
          if (_121 instanceof Data_Maybe.Just) {
              return function __do() {
                  React.render(React.createFactory(Component_App.appClass)(Prelude.unit))(_121.value0)();
                  return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit)();
              };
          };
          throw new Error("Failed pattern match at Main line 29, column 1 - line 30, column 1: " + [ _121.constructor.name ]);
      })()();
  };
  exports["main"] = main;
  exports["body"] = body;;
